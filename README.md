...
- Room creation, share-link generation, public join admission, the join-side device preview, lobby approval flow, SFU token handoff, the first basic in-call UI, the network health badge, and the installable PWA shell are in place for the core 1:1 flow.
