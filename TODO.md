...
| Join screen with device preview | `done` | Issue #6. Added preset selection, media toggles, and permission-triggered preview on the room join screen | [docs/07-frontend-architecture.md](docs/07-frontend-architecture.md) |
